...
abstract class $TransferCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String senderId, String recipientId, double amount, DateTime timestamp});
}
...
class _$TransferImpl implements _Transfer {
  ...
  @override
  String toString() {
    return 'Transfer(senderId: $senderId, recipientId: $recipientId, amount: $amount, timestamp: $timestamp)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, senderId, recipientId, amount, timestamp);
...
abstract class _Transfer implements Transfer {
  factory _Transfer(
      ...
      required final DateTime timestamp}) = _$TransferImpl;
